...
#ifdef ADDON_MIH
    DOT16_TIMER_SendPeriodicReport, //timer to send periodc Link Parameter Report Indications
#endif
...
{
    MESSAGE_InfoAlloc(node, msg, sizeof(Dot16BurstInfo));
    memcpy(MESSAGE_ReturnInfo(msg), burstInfo, sizeof(Dot16BurstInfo));
}
