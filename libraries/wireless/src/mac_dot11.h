...
#ifdef ADDON_MIH
#define DOT11_HANDOVER_RSS_MARGIN 1.0
#else
...
#ifdef ADDON_MIH
// /**
// CONSTANT    :: DOT11_TIMER_SEND_PERIODIC_REPORT_INTERVAL    (1 * SECOND)
// DESCRIPTION :: Time between periodic Link Parameter Report Indications sent to
//                802.21 MIH Function
// **/
#define DOT11_TIMER_SEND_PERIODIC_REPORT_INTERVAL   (1 * SECOND)
