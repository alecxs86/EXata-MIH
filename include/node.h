...
struct Node {
    ...
    MacDataAbstract abstractData;
#endif /* MAC_ABSTRACT_ENABLED */

    ChangeParamValueQueue changeParamValueQueue;
    ...
    SnmpAgentClass * snmpAgent;             // SNMP agent
    char sysContact[128];
    char sysLocation[128];
#endif
    ...
    // STATS DB CODE
#ifdef ADDON_DB
    StatsDBNodeData *statsDBData; // store stats DB specific data
