...
//MM-ends
    ...
    MSG_EXTERNAL_CES2_StatsLogTimer,
    MSG_EXTERNAL_CES2_GraphLogTimer,
    MSG_EXTERNAL_CES_StatsLogTimer,
    MSG_MacCesEplrsSlotTimerExpired,
    MSG_EXTERNAL_CES_GraphLogTimer,
...
#ifdef ADDON_MIH
//	MSG_MIH_MihfToMihf,
    MSG_MIH_LinkGoingDownTimerAlarm			= 2001,
	MSG_MIH_TransactionLifetimeAlarm		= 2002,
	MSG_MIH_RetransmissionTimerAlarm		= 2003,
	MSG_Link_Capability_Discover_request	= 2004,
	MSG_Link_Event_Subscribe_request		= 2005,
	MSG_Link_Event_Unsubscribe_request		= 2006,
	MSG_Link_Get_Parameters_request			= 2007,
	MSG_Link_Configure_Thresholds_request	= 2008,
	MSG_MAC_Link_Action_request				= 2009,
	MSG_MAC_Link_PDU_Transmit_Status_indication = 2010,
	MSG_MAC_Link_Capability_Discover_confirm	= 2011,
	MSG_MAC_Link_Event_Subscribe_confirm		= 2012,
	MSG_MAC_Link_Going_Down_Indication			= 2013,
	MSG_MAC_Link_Handover_Iminent_indication	= 2014,
	MSG_MAC_Link_Handover_Complete_indication	= 2015,
	MSG_MAC_Event_Unsubscribe_confirm			= 2016,
	MSG_MAC_Get_Parameters_confirm				= 2017,
	MSG_MAC_Link_Configure_Thresholds_confirm	= 2018,
	MSG_MAC_Link_Action_confirm					= 2019,
	MSG_MAC_Link_Parameters_Report_indication	= 2020,
	MSG_MAC_Link_Detected_indication			= 2021,
	MSG_MAC_Link_Up_indication					= 2022,
	MSG_MAC_Link_Down_indication				= 2023,
	MSG_Link_Action_request						= 2024,
	MSG_MAC_DOT11_TIMER_SendPeriodicReport		= 2025,
	MSG_MIH_Report_Best_PoA						= 2026,
	MSG_NETWORK_Alert_Route_Packet				= 2030,
#endif
