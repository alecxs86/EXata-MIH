...
#ifdef ADDON_MIH   //data packet dropped due to UE being deregistered
	int numPsPktDroppedUeDeregistered;
#endif
...
#ifdef ADDON_MIH
	int numLinkGoingDownIndSent; 
	int numLink_Parameters_Report_indication; 
	int numLink_Up_indication;
	int numLinkHandoverIminent;
	int numLinkHandoverComplete;
	int numLink_Down_indication;
	int numLinkGetParamsConf;
	int numLinkGetParamsReq;
...
struct UmtsRrcUeData
{
	...
	BOOL		isFirstTimeRegistered;	//Store whether it has performed the first registration procedure before disconnecting
#endif
...
typedef struct struct_umts_layer3_ue_str
{
	...
	MAC_PROTOCOL bestPoaIdMacProtocol;
