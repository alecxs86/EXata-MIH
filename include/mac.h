...
enum MAC_PROTOCOL
{
    ...
    MAC_PROTOCOL_CES_SRW_PORT_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_LLC_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_LLC_LMC,
    MAC_PROTOCOL_CES_SRW_PORT_LLC_QUEUE,
    MAC_PROTOCOL_CES_SRW_PORT_INTRANET_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_OSAL_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_SNDCF_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_SRD_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_EVENT_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_DSP_CONTROLLER,
    MAC_PROTOCOL_CES_SRW_PORT_DSP_ATP,
    MAC_PROTOCOL_CES_SRW_PORT_DSP_MAC,
    MAC_PROTOCOL_CES_SRW_PORT_DSP_ND,
...
void HandleMacDBEvents(
    ...
    int phyIndex, int interfaceIndex,
    MacDBEventType eventType, MAC_PROTOCOL protocol, 
    BOOL failureTypeSpecifed = FALSE, std::string failureType = "");
