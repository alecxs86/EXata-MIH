...
#ifdef ADDON_MIH
	/*CellularLayer3Data *cellularData = (CellularLayer3Data *) node->networkData.cellularLayer3Var;
	UmtsLayer3Data *umtsL3 = cellularData->umtsL3;
	UmtsLayer3Ue *ueL3 = (UmtsLayer3Ue*) umtsL3->dataPtr;
	if (ueL3->bestPoaId != 0)
		Umts_Link_Parameters_Report_indication(node, umtsL3, IN_DB(burstInfo->burstPower_mW), burstInfo->cinr, burstInfo->scCodeIndex);*/
#endif
}
