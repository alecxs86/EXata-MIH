...
#ifdef ADDON_MIH
// /**
// CONSTANT    :: DOT16_TIMER_SEND_PERIODIC_REPORT_INTERVAL    (1 * SECOND)
// DESCRIPTION :: Time between periodic Link Parameter Report Indications sent to
//                802.21 MIH Function
// **/
#define DOT16_TIMER_SEND_PERIODIC_REPORT_INTERVAL   (200 * MILLI_SECOND)
...
//
    ...
    double hoCinrMargin;			//Margin of CINR level to init Bs HO
#endif
    //dot16e
    //idle/paging
    UInt16 macHashSkipThshld;
...
//--------
	...
	int numLinkParametersReportInd;
#endif
} MacDot16BsStats;
