    ...
    DOT11_Frame* frame)
{
    ...
    // Management frame type starts from DOT11_ASSOC_REQ =
    // 0x00 (00 0000), so any change in that might require
    // to include the lower boundary condition checking. e.g
    // if( (hdr->frameType >= DOT11_ASSOC_REQ) &&
    //     (hdr->frameType <= DOT11_ACTION) ) {
